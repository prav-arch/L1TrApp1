-- ClickHouse 18.16.1 Compatible SQL Commands
-- Execute these commands directly in ClickHouse client
...
-- Create table with ClickHouse 18.x syntax (legacy MergeTree)
...
-- Insert data using VALUES syntax
...
-- Show sample data
SELECT id, type, severity, description FROM anomalies ORDER BY timestamp DESC LIMIT 5;